...
if __name__ == '__main__':
    # Read airport data from an Excel file
    airport_df = read_airport_data("Airport_Map_with_Weather.xlsx")

    # Read flight data from an Excel file
    flight_df = read_flight_data("flight_data.xlsx")

    # Update flight data with nearest airports
    ...
    # Set up the layout and callbacks for the app using the create_dash_app function
    app = create_dash_app()

    # Start the Waitress server and serve the Dash app
    from waitress import serve
